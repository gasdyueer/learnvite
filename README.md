...
- **[Lua 脚本指南 v3.0 - 完整参考手册](/docs/script-guide.md)**
  AviUtl ExEdit2 Lua 脚本编写完整参考手册 v3.0。基于最新官方文档重构，覆盖像素操作、音频处理、着色器操作等高级功能，含粒子系统、音频可视化、3D旋转、波浪文字等实用示例，以及性能优化和故障排除指南。
- **[AviUtl2 扩展编辑器完整指南](/docs/aviutl2-guide.md)**
  AviUtl2 扩展编辑器完整使用指南。涵盖模块化用户界面、对象类型（视频/图像/文本/图形/脚本）、控制字符语法、快捷键配置、插件管理和故障排除，适合从初学者到高级用户的完整学习路径。
